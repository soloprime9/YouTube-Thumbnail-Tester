...
export const metadata = {
  ...
  twitter: {
    ...
    images: [
      "https://youtubethumbnailtester.vercel.app/twitter-image.jpg",
    ],
  },
};
  ...
  return (
    <html lang="en">
      <head>
        <link
          rel="canonical"
          href="https://youtubethumbnailtester.vercel.app/"
        />
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          ...
          <ul className="mt-4 space-y-2">
            <li>
              <a href="/tester" className="text-gray-600 hover:text-red-600">
                Preview Tester
              </a>
            </li>
            <li>
              <a href="/analyzer" className="text-gray-600 hover:text-red-600">
                CTR Analyzer
              </a>
            </li>
            <li>
              <a href="/templates" className="text-gray-600 hover:text-red-600">
                Templates
              </a>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2">
            ...
            <li>
              <a href="/case-studies" className="text-gray-600 hover:text-red-600">
                Case Studies
              </a>
            </li>
            <li>
              <a href="/docs" className="text-gray-600 hover:text-red-600">
                Documentation
              </a>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2">
            <li>
              <a href="/privacy" className="text-gray-600 hover:text-red-600">
                Privacy
              </a>
            </li>
            <li>
              <a href="/terms" className="text-gray-600 hover:text-red-600">
                Terms
              </a>
            </li>
            <li>
              <a href="/license" className="text-gray-600 hover:text-red-600">
                License
              </a>
            </li>
          </ul>
